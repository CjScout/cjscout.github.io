...
export const blogPosts: BlogPost[] = [
    {
        ...
        body: [
            "Earlier this week I spoke at the Board of Selectmen meeting about a possible 287(g) agreement between the Hampstead police and ICE. I came in late and without a prepared statement, so I focused on my broad concerns. These are my full thoughts. This statement is also available on my personal website, along with my sources.",
            "I've lived in Hampstead for nearly seventeen years, which is effectively my whole life, and graduated from Pinkerton last June. I'm now studying cybersecurity in college, where one of the core disciplines is risk assessment: before agreeing to something, you weigh how likely each risk is against how much harm it would do, and whether the benefit is worth that exposure. I want to apply this idea to 287(g). I recognize that cybersecurity is very different from immigration law or day-to-day policing, but the core concepts carries over.",
            "First, credit to Chief Kelly. Under New Hampshire law, signing this agreement is the police chief's decision alone. He could have done it quietly. Instead, he brought it before the town and answered every question he could. My concerns are with the agreement, not with him.",
