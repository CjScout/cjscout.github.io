...
export const blogPosts: BlogPost[] = [
    {
        ...
        body: [
            ...
            "I've lived in [my hometown] for nearly seventeen years, which is effectively my whole life, and graduated from [the regional highschool] last June. I'm now studying cybersecurity in college, where one of the core disciplines is risk assessment: before agreeing to something, you weigh how likely each risk is against how much harm it would do, and whether the benefit is worth that exposure. I want to apply this idea to 287(g). I recognize that cybersecurity is very different from immigration law or day-to-day policing, but the core concepts carries over.",
